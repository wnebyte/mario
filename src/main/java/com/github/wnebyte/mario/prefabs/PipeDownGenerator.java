...
public class PipeDownGenerator implements Prefab {

    public PipeDownGenerator() {
        loadResources();
    }
    ...
    public GameObject generate(Sprite sprite) {
        ...
        GameObject pipe = Scene.createGameObject(sprite, "Pipe_Down", 0.5f, 0.5f);
        ...
        pipe.addComponent(new Pipe(Direction.DOWN));
