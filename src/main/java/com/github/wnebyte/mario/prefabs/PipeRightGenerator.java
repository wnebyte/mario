...
public class PipeRightGenerator implements Prefab {

    public PipeRightGenerator() {
        loadResources();
    }
    ...
    public GameObject generate(Sprite sprite) {
        ...
        GameObject pipe = Scene.createGameObject(sprite, "Pipe_Right", 0.5f, 0.5f);
        ...
        pipe.addComponent(new Pipe(Direction.RIGHT));
