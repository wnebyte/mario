...
public class PipeUpGenerator implements Prefab {

    public PipeUpGenerator() {
        loadResources();
    }
    ...
    public GameObject generate(Sprite sprite) {
        ...
        GameObject pipe = Scene.createGameObject(sprite, "Pipe_Up", 0.5f, 0.5f);
        ...
        pipe.addComponent(new Pipe(Direction.UP));
